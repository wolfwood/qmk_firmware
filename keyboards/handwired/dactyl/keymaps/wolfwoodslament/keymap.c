...
[BASE] = LAYOUT_dactyl(  // layer 0 : default
	  ...
	  LT(SYMB,KC_QUOT),KC_GRAVE,       KC_TILD,  KC_LEFT,  KC_RGHT,
	                                                             LCTL_T(KC_ESC),  TG(ESO),
                                                                                      KC_HOME,
	                                           KC_BSPC,   LGUI_T(KC_SPC),  SCMD_T(KC_END),
        // right hand
          ...
          TG(MOUS), LGUI_T(KC_ESC),
          KC_PGUP,
          KC_PGDN,  LCTL_T(KC_ENT), LALT_T(KC_TAB)
    ),
...
[ESO] = LAYOUT_dactyl(
       ...
       KC_LCTRL, KC_GRAVE, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
