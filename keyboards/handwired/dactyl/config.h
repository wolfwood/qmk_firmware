...
#define COL_EXPANDED { true, true, true, true, true, true, true, true, false, false, false, false, false, false, false}
#define MATRIX_ONBOARD_ROW_PINS { F0, F1, F4, F5, F6, F7 }
#define MATRIX_ONBOARD_COL_PINS { 0, 0, 0, 0, 0, 0, 0, 0, B0, B1, B2, B3, D2, D3, C6 }
